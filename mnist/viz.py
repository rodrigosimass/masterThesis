...
def viz_class_activity_2D(data, labels):
    ...
    plt.savefig(f"mnist/img/class_activity_2D.png", bbox_inches="tight")
...
def viz_class_activity_1D(data, labels):
    ...
    plt.savefig(f"mnist/img/class_activity_1D.png", bbox_inches="tight")
...
def viz_activity(data, labels):
    ...
    plt.savefig(f"mnist/img/activity.png", bbox_inches="tight")